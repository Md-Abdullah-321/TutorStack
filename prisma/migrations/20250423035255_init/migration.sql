-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'STUDENT', 'INSTRUCTOR', 'ADMIN');

-- CreateEnum
CREATE TYPE "ResourceType" AS ENUM ('PDF', 'VIDEO', 'SLIDE', 'LINK', 'IMAGE');

-- CreateEnum
CREATE TYPE "EnrollmentStatus" AS ENUM ('PENDING', 'ACTIVE', 'COMPLETED', 'DROPPED');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COURSE_UPDATE', 'MESSAGE', 'SYSTEM_ALERT', 'PROGRESS_UPDATE');
